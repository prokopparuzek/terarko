...
CO\textsubscript{2} v ložnici a rozšířit tak měření třeba na celý dům.
...
%
\input{text/stat.tex} % text vkládán ze souboru. Pokud je v souboru uveden i příkaz \chapter{...}, tak ho 

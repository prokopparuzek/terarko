...
změřil, ale neodeslal. Když přijdu o jedno měření během krátkého výpadku, tak to vadit nebude.% a při větším nebo nějaké chybě si toho 
...
průměrná, nejvyšší, nejnižší hodnota či medián\ldots % Případně různé tendence, derivace, co bude v možnostech 
%vybraného nástroje.

% UI
Nároky na uživatelské rozhraní v podstatě nemám. Pro správu senzorů je nepotřebné. Stejně moc obměňovat či přidávat 
nebudu, a i kdyby stejně si  pro ně budu muset napsat obslužný program. Udělat nějakou \glslink{knihovna}{knihovnu} pro 

...
{
  name={hosting},
  description={Pronájem prostoru pro webové stránky na cizím serveru.}
}
\newglossaryentry{github}
{
  name={GitHub},
  description={GitHub je webová služba podporující vývoj softwaru za pomoci verzovacího nástroje \gls{git}. GitHub 
  nabízí bezplatný \gls{hosting} pro open source projekty. V roce 2018 ho koupil Microsoft.}
}
\newglossaryentry{git}{
  name={Git},
  ...
  spravuje Junio Haman, je šířen pod GPL verze 2 a jedná se o svobodný software.}
}
